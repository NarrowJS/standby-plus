...
import { useDraggable, type DraggableConstraints, type UseDroppableOptions } from "@mgcrea/react-native-dnd"
 ...
 */
export const DraggableSave: FunctionComponent<PropsWithChildren<DraggableProps>> = ({
  children,
  id,
  data,
  disabled,
